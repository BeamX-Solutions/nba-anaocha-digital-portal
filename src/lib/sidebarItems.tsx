import { FileText, BookOpen, CreditCard, Users, Phone, Home, BookMarked, Scale, FolderOpen, Info, Newspaper } from "lucide-react";
...
export const anaochaSidebarItems = [
  ...
  { label: "My Documents",         href: "/anaocha/my-documents", icon: <FolderOpen className="h-4 w-4" /> },
  ...
  { label: "About the Branch",     href: "/anaocha/about",        icon: <Info className="h-4 w-4" /> },
