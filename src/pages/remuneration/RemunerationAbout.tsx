import { Home, FileText, FolderOpen, CreditCard, Search, Bell, File, Scale, ShieldCheck, BookOpen } from "lucide-react";
...
const RemunerationAbout = () => (
  <RemunerationLayout sidebarItems={sidebarItems}>
    <div className="space-y-8">
      <div>
        <h1 className="font-heading text-3xl font-bold text-foreground">About the Remuneration Portal</h1>
